  ...
  <div className="min-h-screen bg-[#07070C] text-[#F1F5F9] overflow-x-hidden">
    ...
    <header className="sticky top-0 z-50 border-b border-[rgba(255,255,255,0.045)]" style={{ background: 'rgba(7,7,12,0.88)', backdropFilter: 'blur(20px) saturate(1.8)' }}>
      <div className="max-w-[1120px] mx-auto flex items-center justify-between px-6 h-[60px]">
        ...
        <nav className="hidden md:flex items-center gap-1" aria-label="Main navigation">
          {[['Features', '#features'], ['Security', '#security'], ['Changelog', '#']].map(([label, href]) => (
            <a key={label} href={href} className="px-3.5 py-2 text-[0.8125rem] text-[#64748B] hover:text-[#CBD5E1] rounded-lg hover:bg-white/[0.04] transition-all font-medium">
              {label}
            </a>
          ))}
        </nav>
    ...
    <section className="relative overflow-hidden pt-32 pb-28 px-6">
      <div className="absolute inset-0 pointer-events-none select-none" aria-hidden="true">
        ...
        <div className="absolute inset-0 opacity-[0.022]" style={{ backgroundImage: 'radial-gradient(circle, #6366F1 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
      </div>
      ...
      <div className="max-w-[1120px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          {/* Left */}
          <motion.div className="flex flex-col gap-8" {...fadeUp(0)}>
            <div className="inline-flex self-start items-center gap-2 px-3.5 py-2 rounded-full border border-indigo-500/18 bg-indigo-500/6 text-indigo-300 text-[0.6875rem] font-semibold">
            ...
            <p className="text-[#64748B] text-[1.0625rem] leading-[1.75] max-w-md">
          ...
          <motion.div className="relative" {...fadeUp(0.12)}>
            <div className="rounded-2xl border border-[rgba(255,255,255,0.08)] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.85),0_0_0_1px_rgba(99,102,241,0.06)]">
              <div className="flex items-center gap-1.5 px-4 py-3 bg-[#0B0B12] border-b border-[rgba(255,255,255,0.05)]">
              ...
              <div className="grid grid-cols-2 gap-1.5 p-3 bg-[#050810]">
                {[
                  ...
                  <div
                    ...
                    className={`aspect-video rounded-xl relative overflow-hidden flex items-center justify-center border transition-all ${
                      active ? 'border-indigo-500/55 shadow-[0_0_0_2px_rgba(99,102,241,0.22)]' : 'border-white/[0.04]'
                    }`}
              ...
              <div className="flex items-center gap-3 px-4 py-3 border-t border-[rgba(255,255,255,0.04)] bg-[#0B0B12]">
            ...
            <motion.div
              className="absolute -bottom-4 -left-5 hidden xl:block w-52 rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[#0F0F18] shadow-2xl p-4"
              animate={{ y: [0, -6, 0] }}
            ...
            <motion.div
              className="absolute -top-3 -right-3 hidden xl:flex items-center gap-2 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[#0F0F18] shadow-xl px-3 py-2.5"
              animate={{ y: [0, -4, 0] }}
    ...
    {/* LOGO MARQUEE */}
    <section className="py-14 border-y border-[rgba(255,255,255,0.04)] overflow-hidden relative" aria-label="Trusted by teams at">
      ...
      <p className="text-center text-[0.625rem] text-[#2D3A4A] uppercase tracking-[0.15em] font-semibold mb-6">
        Trusted by teams at
      </p>
    ...
    {/* STATS */}
    <section className="py-24 px-6" aria-label="Platform statistics">
      <div className="max-w-[1120px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-y divide-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.04)] rounded-2xl overflow-hidden">
          {STATS.map(({ value, label }, i) => (
            <motion.div key={label} className="flex flex-col items-center gap-2 py-12 px-6 bg-[#07070C] text-center" {...fadeUp(i * 0.06)}>
              <p className="text-[2.25rem] font-bold text-[#F1F5F9] tracking-tight leading-none">{value}</p>
              <p className="text-xs text-[#3F4D5C] font-medium tracking-wide">{label}</p>
            </motion.div>
          ))}
        </div>
      </div>
    ...
    <section id="features" className="py-28 px-6">
      <div className="max-w-[1120px] mx-auto">
        <motion.div className="mb-16" {...fadeUp()}>
          ...
          <p className="text-[#64748B] mt-4 max-w-md text-[0.9375rem] leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 stagger">
          {FEATURES.map(({ icon: Icon, label, desc, color, bg, border }) => (
            <motion.div
              key={label}
              className={`group rounded-2xl border ${border} ${bg} p-7 hover:border-opacity-50 transition-all duration-200 hover:-translate-y-0.5 animate-fade-in cursor-default`}
              whileHover={{ y: -2 }}
            ...
            >
              ...
              <h3 className="text-[0.9375rem] font-semibold text-[#F1F5F9] mb-2 tracking-tight">{label}</h3>
              <p className="text-[0.8125rem] text-[#64748B] leading-relaxed">{desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
    ...
    {/* AI SECTION */}
    <section className="py-28 px-6 relative overflow-hidden border-t border-[rgba(255,255,255,0.035)]">
      ...
      <div className="max-w-[1120px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <motion.div {...fadeUp()}>
            ...
            <h2 className="text-h2 text-[#F1F5F9] mb-5">
              Your meetings,<br />
              <span className="gradient-text">intelligently captured</span>
            </h2>
            <p className="text-[#64748B] text-[0.9375rem] leading-relaxed mb-10 max-w-sm">
            ...
            <div className="flex flex-col gap-5">
              {AI_FEATURES.map(({ icon: Icon, label, desc }) => (
                <div key={label} className="flex items-start gap-4">
                  <div className="w-9 h-9 rounded-xl bg-violet-500/8 border border-violet-500/14 flex items-center justify-center shrink-0 mt-0.5">
                    <Icon size={15} className="text-violet-400" />
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-[#CBD5E1]">{label}</p>
                    <p className="text-xs text-[#475569] mt-1 leading-relaxed">{desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <motion.div {...fadeUp(0.1)}>
            <div className="rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[#0F0F18] overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.75)]">
              <div className="flex items-center gap-2 px-5 py-3.5 border-b border-[rgba(255,255,255,0.05)] bg-[#0B0B12]">
              ...
              <div className="p-5 flex flex-col gap-4 min-h-[280px]">
                <div className="rounded-xl bg-[rgba(124,58,237,0.055)] border border-violet-500/10 p-4">
                ...
                <div>
                  <p className="text-[10px] font-semibold text-[#2D3A4A] uppercase tracking-[0.1em] mb-2.5">Action Items</p>
                  {[
                    ...
                    <div key={text} className="flex items-center gap-2 py-2 border-b border-[rgba(255,255,255,0.04)] last:border-0">
                ...
                <div className="mt-auto flex items-center gap-2 rounded-xl bg-white/[0.025] border border-[rgba(255,255,255,0.055)] px-3.5 py-3">
    ...
    {/* SECURITY */}
    <section id="security" className="py-28 px-6 border-t border-[rgba(255,255,255,0.035)]">
      <div className="max-w-[1120px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 stagger">
          {SECURITY.map(({ icon: Icon, title, desc }) => (
            <motion.div
              key={title}
              className="rounded-2xl bg-[rgba(255,255,255,0.018)] border border-[rgba(255,255,255,0.06)] flex items-start gap-4 animate-fade-in hover:border-[rgba(255,255,255,0.1)] transition-colors group"
              style={{ padding: '24px' }}
            >
              <div className="w-9 h-9 rounded-xl bg-indigo-500/7 border border-indigo-500/12 flex items-center justify-center shrink-0">
                <Icon size={15} className="text-indigo-400" />
              </div>
              <div>
                <p className="text-sm font-semibold text-[#CBD5E1] mb-1.5 tracking-tight">{title}</p>
    ...
    {/* TESTIMONIALS */}
    <section className="py-28 px-6 border-t border-[rgba(255,255,255,0.035)]">
      <div className="max-w-[1120px] mx-auto">
        <motion.div className="text-center mb-16" {...fadeUp()}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 stagger">
          {TESTIMONIALS.map(({ quote, name, role, initials, stars }) => (
            <motion.div
              key={name}
              className="rounded-2xl border border-[rgba(255,255,255,0.06)] bg-[#0F0F18] p-7 flex flex-col gap-5 animate-fade-in hover:border-[rgba(255,255,255,0.1)] transition-colors"
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#3F4D5C] mt-0.5">{role}</p>
                </div>
              </div>
            </motion.div>
          ))}
    ...
    {/* CTA STRIP */}
    <section className="py-32 px-6 relative overflow-hidden border-t border-[rgba(255,255,255,0.035)]">
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
      ...
      <div className="max-w-xl mx-auto text-center relative">
        <motion.div {...fadeUp()}>
          <h2 className="text-h2 text-[#F1F5F9] mb-5">Start running smarter meetings</h2>
          ...
          <p className="text-xs text-[#2D3A4A] mt-6">No credit card · Free forever plan · Cancel anytime</p>
        </motion.div>
      </div>
    </section>

    {/* FOOTER */}
    <footer className="border-t border-[rgba(255,255,255,0.035)] py-20 px-6">
      <div className="max-w-[1120px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
          ...
          {[
            ...
            <div key={label}>
              <p className="text-[10px] font-semibold text-[#2D3A4A] uppercase tracking-[0.1em] mb-4">{label}</p>
        ...
        <div className="border-t border-[rgba(255,255,255,0.035)] pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
