...
const GoogleLoginButton = ({ label = 'Continue with Google' }: Props) => {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 py-2.5 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] text-[0.8125rem] font-medium text-[#CBD5E1] hover:bg-[rgba(255,255,255,0.06)] hover:border-[rgba(255,255,255,0.12)] transition-all disabled:opacity-60 disabled:cursor-not-allowed mb-5"
      aria-label={label}
    >
      {loading ? (
