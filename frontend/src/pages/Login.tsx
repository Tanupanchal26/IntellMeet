    ...
    <div style={{
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
              ...
              <a href="#" style={{ fontSize: '0.8rem', color: '#6D28D9', textDecoration: 'none', fontWeight: 500 }}>
                Forgot password?
              </a>
            </div>
            <input
        ...
        <div style={{ textAlign: 'center', marginTop: '24px', fontSize: '0.85rem', color: '#6B7280' }}>
          ...
          <Link to={ROUTES.REGISTER} style={{ color: '#6D28D9', textDecoration: 'none', fontWeight: 600 }}>
            Sign up
          </Link>
        </div>
      </motion.div>
